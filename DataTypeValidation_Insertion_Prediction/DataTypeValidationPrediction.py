...
class dBOperation:
    ...
    def dataBaseConnection(self,DatabaseName):
        ...
        """
                        ...
                        """
        try:
            conn = sqlite3.connect(self.path+DatabaseName+'.db')  # data is in Training_Database folder as Training.db
            ...
            try:
                ...
                with open(goodFilePath+'/'+file, "r") as f:
                    ...
                    for line in enumerate(reader):
                        for list_ in (line[1]):
                            try:  # data is in Training_Database folder as Training.db
