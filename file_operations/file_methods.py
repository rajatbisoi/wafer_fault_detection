...
"""
    ...
    def load_model(self,filename):
        ...
        try:
            ...
            f = self.aws.Download_From_S3_raw(filename,bucket_prefix='wafer-model')
            self.logger_object.log(self.file_object,
    ...
    def find_correct_model_file(self,cluster_number):
        ...
        try:
            ...
            self.list_of_files = self.aws.Create_S3_Bucket_Instance(bucket_prefix="wafer-model").objects.all()
